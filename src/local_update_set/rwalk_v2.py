        ...
        for iter in range(self.args.local_ep):
            ...
            for batch_idx, (images, labels) in enumerate(self.trainloader):
                ...
                if not global_round == 0: #TODO first step! -> Not using fisher info
                    ...
                    reg_loss = self.ewc_lambda * reg_loss * 0.5
                    reg_loss.backward()
                optimizer.step()
                ...
                if global_round >1: #TODO first step! -> Not using fisher info
                    ...
                    for n, p in model.named_parameters():
                        if gradient[n] is not None:
                            ...
                            #information[n] = 0.*nn.functional.relu(batch_score_info.detach()/len(self.fisherloader))
